#!/usr/bin/env node
/**
 * @package IDEALORO-PREVIEW — Asset Scraper
 * @author Padmin D. Curtis (AI Partner OS3.0) for Fabio Cherici
 * @version 1.0.0 (FlorenceEGI — IDEALORO-PREVIEW)
 * @date 2026-04-17
 * @purpose Scraping immagini da preview.florenceegi.com → public/images/original/.
...
const BASE = 'https://www.preview.florenceegi.com';
const PAGES = [
  '/',
  '/quotazione-oro/',
  '/investire-in-oro/',
...
function isAsset(url) {
  if (!url) return false;
  if (!url.includes('preview.florenceegi.com')) return false;
