/**
 * @package IDEALORO-PREVIEW — Schema.org JSON-LD helpers
...
export const BUSINESS = {
  id: 'https://preview.florenceegi.com/#business',
  legalName: 'IdealOro Gioielleria - Compro Oro',
  name: 'IdealOro',
  vatId: 'IT12345678901',
  url: 'https://preview.florenceegi.com',
  logo: 'https://preview.florenceegi.com/images/logo.svg',
  image: 'https://preview.florenceegi.com/images/og-home.jpg',
  telephone: '+390550000000',
  mobile: '+393900000000',
  email: 'info@preview.florenceegi.com',
  address: {
  ...
  geo: { latitude: 43.7700, longitude: 11.2500 },
  openingHours: [
...
export function webSiteSchema(locale: 'it' | 'en'): SchemaObject {
  return {
    ...
    name: locale === 'it' ? 'IdealOro' : 'IdealOro',
    url: BUSINESS.url,
...
export function goldQuotesDatasetSchema(rows: QuoteRow[], pageUrl: string): SchemaObject {
  return {
    '@context': 'https://schema.org',
    '@type': 'Dataset',
    name: 'Quotazioni oro e argento IdealOro',
